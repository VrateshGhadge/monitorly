/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 7079608712d643350b45cb531a5fb72f)
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "DATABASE_URL" | "JWT_SECRET" | "RESEND_API_KEY">
  > {}
}
...
type AiSearchItemInfo = {
  ...
  key: string;
  status:
    "completed" | "error" | "skipped" | "queued" | "processing" | "outdated";
  metadata?: Record<string, unknown>;
  [key: string]: unknown;
};
